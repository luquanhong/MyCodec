...
/* 2009.05.13 by icarus: YUV420SP -> YUV420P (SW rendering) */
#if defined(SW_RENDERER) && defined(ZERO_COPY)
#error "SW_RENDERER and ZERO_COPY can not be defined together"
#endif

#if defined(SLSI_S5PC110) && !defined(ZERO_COPY)
#error "S5PC110 should use ZERO_COPY function"
#endif

#if defined(SW_RENDERER) && defined(BOARD_USES_HDMI)
#error "SW_RENDERER and BOARD_USES_HDMI can not be defined together"
#endif
...
#if defined(SLSI_S5PC100)
    ColorConvertBase* iColorConverterYUV;
#endif
#endif
