...
/* 2009.06.29 by icarus for thumbnail */
...
/* 2009.09.28 by icarus delete BEST_THUMBNAIL_MODE */
...
private:
    ...
    /* 2009.06.29 by icarus : increase size for 720p contents */
    static const uint32 MAX_VIDEO_FRAME_SIZE = 1280 * 720 * 3 / 2;
#elif defined(SLSI_S5PC110)
    static const uint32 MAX_VIDEO_FRAME_SIZE = 1920 * 1088 * 3 / 2;
#else
...
#if defined(SLSI_S5PC100) || defined(SLSI_S5PC110)
    /* 2009.06.29 by icarus for thumbnail */
    PvmiCapabilityAndConfig *mUtilCapConfig;
#endif
