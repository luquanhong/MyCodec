...
extern "C"
{
    ...
    **************************************************************************/
    ...
    Void BlockDCT_AANzmv(Short *out, UChar *prev, UChar *cur,
                         UChar *rec, Int ColTh, Int lx, Int chroma)
    {
        Short *dst;
        Int k0, k1, k2, k3, k4, k5, k6, k7;
        Int round;
        ...
        do  /* fdct_nextrow */
        {
            ...
            mask = 0x1FE;
            tmp = *((Int*) cur);	/* contains 4 pixels */
            tmp2 = *((Int*) prev); /* prediction 4 pixels */
            k0 = tmp2 & 0xFF;
            k1 = mask & (tmp << 1);
            k5 = k0;
            k0 = k1 - (k0 << 1);
    ...
    **************************************************************************/
    ...
    Void Block4x4DCT_AANzmv(Short *out, UChar *prev, UChar *cur,
                            UChar *rec, Int ColTh, Int lx, Int chroma)
    {
        Short *dst;
        register Int k0, k1, k2, k3, k4, k5, k6, k7;
    ...
    **************************************************************************/
    ...
    Void Block2x2DCT_AANzmv(Short *out, UChar *prev, UChar *cur,
                            UChar *rec, Int ColTh, Int lx, Int chroma)
    {
        Short *dst;
        register Int k0, k1, k2, k3, k4, k5, k6, k7;
...
#if 0
    /**************************************************************************/
    /*	Function:	Block1x1DCTzmv
    	Date:		8/9/01
    	Input:		prev, rec
    	Output:		out
    	Purpose:	Compute DC value only, do subtraction first
    	Modified:
    **************************************************************************/
