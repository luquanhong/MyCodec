...
//#if defined(SLSI_S5PC110) && defined(BOARD_USES_HDMI)
    /* Set whether this surface should be displayed through the HDMI
    * ui_status
    * 1 : This Surface should be displayed through the HDMI
    * 0 : This Surface should not be displayed through the HDMI
    */
    virtual void displayHdmi(uint32_t ui_status) = 0;
    // returns the number of Surfaces that requested to display through the HDMI
    virtual int postBuffer2HDMI(unsigned int pPhyYAddr, unsigned int pPhyCAddr, int iWidth, int iHeight) = 0;
//#endif
};
